...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function () {
	    ...
	    function eg_indirect(context, reference, useA1) {
	        ...
	        var baseRow = context.row, baseCol = context.column, parser = new CalcParser(),
	            baseIdentity = Calc._createCellIdentity(baseRow, baseCol);
	        var parserContext = context.source ? context.source.getParserContext(!useA1, baseIdentity) : new Calc.ParserContext(context.source, !useA1, baseIdentity);
	        parserContext.onlyValidateSourceNameWithSpecial = true;
	        var expression = parser.parse(parserContext, reference), source;
	        if (expression) {
	    ...
	    defineBuiltInFunction('VLOOKUP', eg_vlookup, 3, 4, [arrayArgDefaultValue, arrayArgDefaultValue,
	        stringIntArgDefaultValue2, boolArgDefaultValue], 1, 1,
	        {
	            _acceptsMissingArgument: 3,
...
/***/ })
/******/ ]);
//# sourceMappingURL=gc.spread.calcengine.advancedfunctions.11.2.7.js.map