...
const routes: Routes = [
  ...
  {path: 'tools', component: ToolsComponent, data: { hasSideBar: false }, children:[
    ...
    { path: 'report', component: ReportComponent, data: { hasSideBar: false }, children: [
      { path: 'canvas/:path', component: ReportDetailsComponent, data: { render: 'canvas' } , children: [
        { path: 'cases/:path', component: ReportContentComponent}
      ]},
      { path: 'svg/:path', component: ReportDetailsComponent, data: { render: 'svg' } , children: [
        { path: 'cases/:path', component: ReportContentComponent}
      ]},
