	...
	(function () {
	    ...
	    var NumberHelper = (function () {
	        ...
	        function _processValueWithScale(value, percent, permille, scale) {
	            ...
	            if (percent > 0) {
	                result = _fixNumber(value * (Math_pow(100, percent)), 15);
	            }
	            if (permille > 0) {
	                result = _fixNumber(value * (Math_pow(1000, permille)), 15);
	            }
	            if (scale > 0) {
	                result = _fixNumber(value / (Math_pow(1000, scale)), 15);
	            }
	            return result;
	        }
...
;
//# sourceMappingURL=gc.spread.common.11.2.7.js.map